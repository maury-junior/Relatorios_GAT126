...
T_Nish = 2+lsim(H_Nish,v,t,2);
T_1const = 2+lsim(H_1const,v,t,2);
T_4const = 2+lsim(H_4const,v,t,2);
T_ZN = 2+lsim(H_ZN,v,t,2);
T_Sm = 2+lsim(H_Sm,v,t,2);
T_Hag = 2+lsim(H_Hag,v,t,2);
T_Sun = 2+lsim(H_Sun,v,t,2);
T_inc = 2+lsim(H_inc,v,t,2);
...
plot(t,T_Sun)
plot(t,T_inc)
legend('Nish','1 const.','4 const.','Ziegler-Nichols','Smith','Haglund','Sundaresan','Inc')